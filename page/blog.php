...
<body>
    ...
    <nav class="nav-head navbar navbar-expand-lg">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand" href="#">de Tech</a>
    ...
    <div class="container mt-5 p-0">
        ...
        <p class="card-text text-center"><small class="text-body-secondary"><?= $result['penulis']; ?> - dels Media</small></p>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <p class="card-text text-start"><small class="text-body-secondary"> https://yangtautauaja.com</small>
                </p>
            </div>
        </div>
        <div class="row mt-3">
            ...
            <div class="row col-lg-4">
                ...
                <div class="img-box">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="../img/ads.jpg" style="width: 100%; height: 100%;" class="img-fluid rounded-start object-fit-cover" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">iPhone</h5>
                                    <p class="card-text">dapatkan iphone dengan harga termurah hanya disitus ini</p>
                                    <div class="card-body">
